...
extern boolean      g_pump_ctrl_pwm_state;
extern uint16_t     g_pump_ctrl_pwm_speed;
extern uint32_t     g_pump_ctrl_pwm_interval;
extern uint32_t     g_pump_ctrl_pwm_ontime;
extern uint32_t     g_pump_ctrl_pwm_offtime;
